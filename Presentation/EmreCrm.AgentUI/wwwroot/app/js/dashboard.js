                ...
                if (0 != $("#m_chart_personal_income_quater_1").length) {
                    ...
                    e.on("draw", function (e) {
                        if ("slice" === e.type) {
                            ...
                            var a = { "stroke-dashoffset": { id: "anim" + e.index, dur: 1e3, from: -t + "px", to: "0px", easing: Chartist.Svg.Easing.easeOutQuint, fill: "freeze", stroke: e.meta.color } };
                            0 !== e.index && (a["stroke-dashoffset"].begin = "anim" + (e.index - 1) + ".end"), e.element.attr({ "stroke-dashoffset": -t + "px", stroke: e.meta.color }), e.element.animate(a, !1);
                        }
                    }),
                                ...
                                !(function () {
                                    if (0 != $("#m_chart_personal_income_quater_2").length) {
                                        var e = new Chartist.Pie(
                                            ...
                                            {
                                                series: [
                                                    { value: 22, className: "custom", meta: { color: mApp.getColor("focus") } },
                                ...
                                !(function () {
                                    if (0 != $("#m_chart_personal_income_quater_3").length) {
                                        var e = new Chartist.Pie(
                                            ...
                                            {
                                                series: [
                                                    { value: 47, className: "custom", meta: { color: mApp.getColor("info") } },
                                ...
                                !(function () {
                                    if (0 != $("#m_chart_personal_income_quater_4").length) {
                                        var e = new Chartist.Pie(
                                            ...
                                            {
                                                series: [
                                                    { value: 37, className: "custom", meta: { color: mApp.getColor("warning") } },
        ...
        init: function () {
            ...
            !(function () {
                ...
                new Chartist.Pie(
                    ...
                    {
                        series: [
                            { value: 32, className: "custom", meta: { color: mApp.getColor("brand") } },
                            { value: 32, className: "custom", meta: { color: mApp.getColor("accent") } },
                            { value: 36, className: "custom", meta: { color: mApp.getColor("warning") } },
                        ],
                        labels: [1, 2, 3],
                    },
                    { donut: !0, donutWidth: 17, showLabel: !1 }
                    ...
                    if (0 != $("#m_chart_sales_stats").length) {
                        var e = {
                            ...
                            options: {
                                ...
                                maintainAspectRatio: !1,
                                hover: { mode: "index" },
                                scales: { xAxes: [{ display: !1, gridLines: !1, scaleLabel: { display: !0, labelString: "Month" } }], yAxes: [{ display: !1, gridLines: !1, scaleLabel: { display: !0, labelString: "Value" } }] },
                ...
                (function () {
                    if (0 != $("#m_chart_trends_stats").length) {
                        ...
                        t.addColorStop(0, Chart.helpers.color("#00c5dc").alpha(0.7).rgbString()), t.addColorStop(1, Chart.helpers.color("#f2feff").alpha(0).rgbString());
                        var a = {
                            type: "line",
                            data: {
                                labels: [
                            ...
                            options: {
                                ...
                                elements: { line: { tension: 0.19 }, point: { radius: 4, borderWidth: 12 } },
                ...
                (function () {
                    if (0 != $("#m_chart_activities").length) {
                        var e = document.getElementById("m_chart_activities").getContext("2d"),
                            t = e.createLinearGradient(0, 0, 0, 240);
                        t.addColorStop(0, Chart.helpers.color("#e14c86").alpha(1).rgbString()), t.addColorStop(1, Chart.helpers.color("#e14c86").alpha(0.3).rgbString());
                        var a = {
                            type: "line",
                            data: {
                                labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October"],
                ...
                (function () {
                    if (0 != $("#m_chart_bandwidth1").length) {
                        var e = document.getElementById("m_chart_bandwidth1").getContext("2d"),
                            t = e.createLinearGradient(0, 0, 0, 240);
                        t.addColorStop(0, Chart.helpers.color("#d1f1ec").alpha(1).rgbString()), t.addColorStop(1, Chart.helpers.color("#d1f1ec").alpha(0.3).rgbString());
                        var a = {
                            type: "line",
                            data: {
                                labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October"],
                ...
                (function () {
                    if (0 != $("#m_chart_bandwidth2").length) {
                        var e = document.getElementById("m_chart_bandwidth2").getContext("2d"),
                            t = e.createLinearGradient(0, 0, 0, 240);
                        t.addColorStop(0, Chart.helpers.color("#ffefce").alpha(1).rgbString()), t.addColorStop(1, Chart.helpers.color("#ffefce").alpha(0.3).rgbString());
                        var a = {
                            type: "line",
                            data: {
                                labels: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October"],
                ...
                (function () {
                    ...
                    function r(t, a, r) {
                        var o = "",
                            n = "";
                        a - t < 100 || "Today" == r ? ((o = "Today:"), (n = t.format("MMM D"))) : "Yesterday" == r ? ((o = "Yesterday:"), (n = t.format("MMM D"))) : (n = t.format("MMM D") + " - " + a.format("MMM D")),
                ...
                $(".m_datatable").mDatatable({
                    ...
                    pagination: !0,
                    columns: [
                        { field: "RecordID", title: "#", sortable: !1, width: 40, selector: { class: "m-checkbox--solid m-checkbox--brand" }, textAlign: "center" },
                ...
                r.owlCarousel({ rtl: mUtil.isRTL(), items: 1, animateIn: "fadeIn(100)", loop: !0 }),
                a.owlCarousel({ rtl: mUtil.isRTL(), center: !0, loop: !0, items: 2 }),
